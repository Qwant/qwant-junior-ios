...
class QwantDefaultSearchPrefsTests: XCTestCase {
    ...
    func testParsing_hasAllInfo_succeeds() {
        ...
        let us = (lang: ["en-US", "en"], region: "US", resultList: ["qwant", "qwant-junior"], resultDefault: "qwant")
        let england = (lang: ["en-GB", "en"], region: "GB", resultList: ["qwant", "qwant-junior"], resultDefault: "qwant")
        let france = (lang: ["fr-FR", "fr"], region: "FR", resultList: ["qwant", "qwant-junior"], resultDefault: "qwant")
        let japan = (lang: ["ja-JP", "ja"], region: "JP", resultList: ["qwant", "qwant-junior"], resultDefault: "qwant")
        let canada = (lang: ["en-CA", "en"], region: "CA", resultList: ["qwant", "qwant-junior"], resultDefault: "qwant")
        let russia = (lang: ["ru-RU", "ru"], region: "RU", resultList: ["qwant", "qwant-junior"], resultDefault: "qwant")
        let taiwan = (lang: ["zh-TW", "zh"], region: "TW", resultList: ["qwant", "qwant-junior"], resultDefault: "qwant")
        let china = (lang: ["zh-hans-CN", "zh-CN", "zh"], region: "CN", resultList: ["qwant", "qwant-junior"], resultDefault: "qwant")
        let germany = (lang: ["de-DE", "de"], region: "DE", resultList: ["qwant", "qwant-junior"], resultDefault: "qwant")
        let southAfrica = (lang: ["en-SA", "en"], region: "SA", resultList: ["qwant", "qwant-junior"], resultDefault: "qwant")
