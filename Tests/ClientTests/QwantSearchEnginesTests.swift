...
class QwantSearchEnginesTest: XCTestCase {
    ...
    func testOrderedEngines() {
        ...
        engines.orderedEngines = [expectedEngineNames[1], expectedEngineNames[0]].map { name in
        ...
        XCTAssertEqual(engines.orderedEngines[0].shortName, expectedEngineNames[1])
        XCTAssertEqual(engines.orderedEngines[1].shortName, expectedEngineNames[0])
        
        let engines2 = SearchEngines(prefs: profile.prefs, files: profile.files)
        // The ordering should have been persisted.
        XCTAssertEqual(engines2.orderedEngines[0].shortName, expectedEngineNames[1])
        XCTAssertEqual(engines2.orderedEngines[1].shortName, expectedEngineNames[0])
    }
