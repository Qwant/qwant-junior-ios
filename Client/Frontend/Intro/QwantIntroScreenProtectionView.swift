...
class QwantIntroScreenProtectionView: UIView {
    ...
    private func initialViewSetup() {
        ...
        NSLayoutConstraint.activate([
            ...
            startBrowsingButton.topAnchor.constraint(equalTo: subtitleLabel.bottomAnchor, constant: QwantUX.Spacing.xxl),
            startBrowsingButton.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor, constant: QwantUX.Spacing.gutterM),
            startBrowsingButton.trailingAnchor.constraint(equalTo: safeAreaLayoutGuide.trailingAnchor, constant: -QwantUX.Spacing.gutterM),
            startBrowsingButton.heightAnchor.constraint(equalToConstant: QwantUX.Spacing.buttonHeight),
            startBrowsingButton.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor, constant: -QwantUX.Spacing.xxl),
        ])
    }
