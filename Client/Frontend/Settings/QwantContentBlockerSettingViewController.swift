...
class FeedbackSetting: Setting {
    private struct Constants {
        ...
        static let subject = "[Qwant VIPrivacy] [iOS - \(VersionSetting.appVersion)]"
        static let body = "\(AppName.longName) \(VersionSetting.appVersion) (\(VersionSetting.appBuildNumber))"
    }
