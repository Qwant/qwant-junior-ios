...
class ContentBlockerSetting: Setting {
    ...
    init(settings: SettingsTableViewController) {
        self.profile = settings.profile
        self.tabManager = settings.tabManager
        super.init(title: NSAttributedString(string: .QwantTrackingProtection.GlobalProtection, attributes: [NSAttributedString.Key.foregroundColor: settings.themeManager.currentTheme.colors.textPrimary]))
    }
...
class PrivacyPolicySetting: Setting {
    ...
    override var url: URL? {
        return URL(string: "https://about.qwant.com/legal/privacy/")
    }
