...
extension String {
    ...
    public static let TrackingProtectionLevelFooter = MZLocalizedString("Settings.TrackingProtection.ProtectionLevel.Footer", value: "If a site doesn’t work as expected, tap the green icon in the address bar and turn off Qwant VIPrivacy for that page.", comment: "Footer information for tracker protection level.", lastUpdated: .qwant340)
...
extension String {
    public struct QwantTrackingProtection {
        public static let ConnectionSecure = MZLocalizedString("Qwant.TrackingProtection.ConnectionSecure", tableName: "QwantTrackingProtection", value: "Connection is secure", comment: "Header - SSL Cert status when the connection is secured", lastUpdated: .qwant340)
        public static let ConnectionNotSecure = MZLocalizedString("Qwant.TrackingProtection.ConnectionNotSecure", tableName: "QwantTrackingProtection", value: "Connection is not secure", comment: "Header - SSL Cert status when the connection is not secured", lastUpdated: .qwant340)
        public static let LocalProtectionEnabledTitle = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.EnabledTitle", tableName: "QwantTrackingProtection", value: "Protection enabled", comment: "Green title when the tracking protection is enabled for the current visited website", lastUpdated: .qwant340)
        public static let LocalProtectionEnablingTitle = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.EnablingTitle", tableName: "QwantTrackingProtection", value: "Enabling protection...", comment: "Pale green title when the tracking protection is enabling for the current visited website", lastUpdated: .qwant340)
        public static let LocalProtectionDisablingTitle = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.DisablingTitle", tableName: "QwantTrackingProtection", value: "Disabling protection...", comment: "Pale red title when the tracking protection is disabling for the current visited website", lastUpdated: .qwant340)
        public static let LocalProtectionLoadingSubtitle = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.LoadingSubtitle", tableName: "QwantTrackingProtection", value: "This operation can take up to 5 seconds, please wait.", comment: "Gray subtitle when the tracking protection is either enabling or disabling for the current visited website", lastUpdated: .qwant340)
        public static let LocalProtectionLongerLoadingSubtitle = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.LongerLoadingSubtitle", tableName: "QwantTrackingProtection", value: "Hang tight. We're almost there...", comment: "Gray subtitle when the tracking protection is either enabling or disabling for the current visited website", lastUpdated: .qwant340)
        public static let LocalProtectionDisabledTitle = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.DisabledTitle", tableName: "QwantTrackingProtection", value: "Protection disabled", comment: "Red title when the tracking protection is disabled for the current visited website", lastUpdated: .qwant340)
        public static let LocalProtectionEnabledSubtitle = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.EnabledSubtitle", tableName: "QwantTrackingProtection", value: "A problem on this website? Try to deactivate.", comment: "Gray subtitle when the tracking protection is enabled for the current visited website", lastUpdated: .qwant340)
        public static let LocalProtectionDisabledSubtitle = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.DisabledSubtitle", tableName: "QwantTrackingProtection", value: "Deactivated for this website.", comment: "Gray subtitle when the tracking protection is disabled for the current visited website", lastUpdated: .qwant340)
        public static let BlockedItems = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.BlockedItems", tableName: "QwantTrackingProtection", value: "Items blocked", comment: "Row title label to explain that the righthand-sight of the cell represents the # of blocked items for the current visited website", lastUpdated: .qwant340)
        public static let ProtectionLevel = MZLocalizedString("Qwant.TrackingProtection.ProtectionLevel.Title", tableName: "QwantTrackingProtection", value: "Level of protection", comment: "Row title label to explain that the righthand-sight of the cell represents the current protection level", lastUpdated: .qwant340)
        public static let StandardTitle = MZLocalizedString("Qwant.TrackingProtection.ProtectionLevel.StandardTitle", tableName: "QwantTrackingProtection", value: "Standard", comment: "Standard protection level", lastUpdated: .qwant340)
        public static let StandardDescription = MZLocalizedString("Qwant.TrackingProtection.ProtectionLevel.StandardDescription", tableName: "QwantTrackingProtection", value: "Blocks most trackers and cookies efficiently", comment: "Description of the standard protection level", lastUpdated: .qwant340)
        public static let StrictTitle = MZLocalizedString("Qwant.TrackingProtection.ProtectionLevel.StrictTitle", tableName: "QwantTrackingProtection", value: "Strict", comment: "Strict protection level", lastUpdated: .qwant340)
        public static let StrictDescription = MZLocalizedString("Qwant.TrackingProtection.ProtectionLevel.StrictDescription", tableName: "QwantTrackingProtection", value: "Blocks all trackers and cookies, may affect some websites", comment: "Description of the strict protection level", lastUpdated: .qwant340)
        public static let DisabledTitle = MZLocalizedString("Qwant.TrackingProtection.ProtectionLevel.DisabledTitle", tableName: "QwantTrackingProtection", value: "Disabled", comment: "Disabled protection level", lastUpdated: .qwant340)
        public static let DisabledDescription = MZLocalizedString("Qwant.TrackingProtection.ProtectionLevel.DisabledDescription", tableName: "QwantTrackingProtection", value: "The browsing protection is disabled", comment: "Description of the disabled protection level", lastUpdated: .qwant340)
        public static let LastThirtyDays = MZLocalizedString("Qwant.TrackingProtection.Statistics.LastThirtyDays", tableName: "QwantTrackingProtection", value: "Last 30 days", comment: "Header of the statistics section", lastUpdated: .qwant340)
        public static let ItemsBlocked = MZLocalizedString("Qwant.TrackingProtection.Statistics.ItemsBlocked", tableName: "QwantTrackingProtection", value: "Items blocked", comment: "Represents the # of items blocked by the tracking protection", lastUpdated: .qwant340)
        public static let TimeSaved = MZLocalizedString("Qwant.TrackingProtection.Statistics.TimeSaved", tableName: "QwantTrackingProtection", value: "Time saved", comment: "Represents the time saved by the tracking protection", lastUpdated: .qwant340)
        public static let SeeDetails = MZLocalizedString("Qwant.TrackingProtection.Statistics.SeeDetails", tableName: "QwantTrackingProtection", value: "See details", comment: "Buttons to redirect to the details of the statistics", lastUpdated: .qwant340)
        public static let LocalProtection = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.ScreenTitle", tableName: "QwantTrackingProtection", value: "Items blocked", comment: "Title of the local protection details page", lastUpdated: .qwant340)
        public static let TrackersTitle = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.TrackersTitle", tableName: "QwantTrackingProtection", value: "Trackers", comment: "Title to describle the value underneath it is the number of items blocked within the current website", lastUpdated: .qwant340)
        public static let DomainsTitle = MZLocalizedString("Qwant.TrackingProtection.LocalProtection.DomainsTitle", tableName: "QwantTrackingProtection", value: "Domains", comment: "Title to describle the value underneath it is the number of domains blocked within the current website", lastUpdated: .qwant340)
    ...
    public struct QwantIntro {
        public static let WelcomeTitle = MZLocalizedString("Qwant.Intro.Welcome.Title", tableName: "Intro", value: "Welcome to Qwant, dear anonymous", comment: "Title for the first panel 'Welcome' in the First Run tour.", lastUpdated: .qwant340)
        public static let WelcomeSubtitle = MZLocalizedString("Qwant.Intro.Welcome.Subtitle", tableName: "Intro", value: "Here, you can search in complete privacy:", comment: "Subtitle for the first panel 'Welcome' in the First Run tour.", lastUpdated: .qwant340)
        public static let WelcomeBullet1 = MZLocalizedString("Qwant.Intro.Welcome.Bullet1", tableName: "Intro", value: "0% tracking", comment: "Bullet point #1 for the first panel 'Welcome' in the First Run tour.", lastUpdated: .qwant340)
        public static let WelcomeBullet2 = MZLocalizedString("Qwant.Intro.Welcome.Bullet2", tableName: "Intro", value: "0% data storage", comment: "Bullet point #2 for the first panel 'Welcome' in the First Run tour.", lastUpdated: .qwant340)
        public static let WelcomeBullet3 = MZLocalizedString("Qwant.Intro.Welcome.Bullet3", tableName: "Intro", value: "0% targeted advertising", comment: "Bullet point #3 for the first panel 'Welcome' in the First Run tour.", lastUpdated: .qwant340)
        public static let WelcomeDefaultBrowser = MZLocalizedString("Qwant.Intro.Welcome.DefaultBrowser", tableName: "Intro", value: "Set as default browser", comment: "Button to invite the user to set Qwant as their default browser for the first panel 'Welcome' in the First Run tour.", lastUpdated: .qwant340)
        public static let WelcomeIgnore = MZLocalizedString("Qwant.Intro.Welcome.Ignore", tableName: "Intro", value: "Ignore", comment: "Button to invite the user to go to the next screen for the first panel 'Welcome' in the First Run tour.", lastUpdated: .qwant340)
        
        public static let ProtectionTitle = MZLocalizedString("Qwant.Intro.Protection.Title", tableName: "Intro", value: "Surf protected on all websites", comment: "Title for the second panel 'Protection' in the First Run tour.", lastUpdated: .qwant340)
        public static let ProtectionBullet1 = MZLocalizedString("Qwant.Intro.Protection.Bullet1", tableName: "Intro", value: "Blocking trackers, finally free!", comment: "Bullet point #1 for the second panel 'Protection' in the First Run tour.", lastUpdated: .qwant340)
        public static let ProtectionBullet2 = MZLocalizedString("Qwant.Intro.Protection.Bullet2", tableName: "Intro", value: "Refuse cookies for you, no more intrusive banners!", comment: "Bullet point #2 for the second panel 'Protection' in the First Run tour.", lastUpdated: .qwant340)
        public static let ProtectionSubtitle = MZLocalizedString("Qwant.Intro.Protection.Subtitle", tableName: "Intro", value: "Learn more about us and do your first search!", comment: "Subtitle for the second panel 'Protection' in the First Run tour.", lastUpdated: .qwant340)
        public static let ProtectionStartBrowsing = MZLocalizedString("Qwant.Intro.Protection.StartBrowsing", tableName: "Intro", value: "Let's get started!", comment: "Button to invite the user to start browsing for the second panel 'Protection' in the First Run tour.", lastUpdated: .qwant340)
